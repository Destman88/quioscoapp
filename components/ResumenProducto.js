  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className="md:w-4/6">
        ...
        <p className="text-sm font-bold text-grey-700 mt-2">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex gap-2 px-5 py-2 text-white justify-center rounded-md font-bold uppercase shadow-md w-full"
